...
if [ `uname -m` == "x86_64" ];then
  #if [ ! -f Percona-Server-5.7.18-16-Linux.x86_64.ssl101.tar.gz ];then
	 #wget http://zy-res.oss-cn-hangzhou.aliyuncs.com/mysql/mysql-5.7.17-linux-glibc2.5-x86_64.tar.gz
  #fi
  tar -xzvf Percona-Server-5.7.18-16-Linux.x86_64.ssl101.tar.gz
  mv Percona-Server-5.7.18-16-Linux.x86_64.ssl101/* /alidata/mysql
fi
